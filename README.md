...
we embedded the flex sensor on a knee cap which placed the flex sensor on the back of the knee and the IMU on the upper right thigh
...
we use a HC-05 bluetooth transmission module to transmitt data from the kneecap to our system where we read said data
